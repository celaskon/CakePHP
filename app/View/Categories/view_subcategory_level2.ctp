<div class="categories_index">
  ...
  <?php  echo 'Ste tu: ' .  
              ...
              . ' -> ' .
              $this->Html->link(__($level2['Category']['name']), array('action' => 'view', $level2['Category']['id']))
              . ' -> ' . 
              $this->Html->link(__($category['Category']['name']), array('action' => 'view_subcategory_level2', $category['Category']['id'])); ?>
  <h2>
  <?php  echo __('Kategória ');
  ...
  foreach ($subCategories as $Subcategory): ?>
	<tr>                                                                                                    
		<td>                                                      
			<?php  echo $this->Html->link(__($Subcategory['Category']['name']), array('action' => 'view_companies', $Subcategory['Category']['id'])); // $this->Html->link(nazov linku, cesta)   ?>
    </td>
	</tr>
  <?php 
  endforeach;  ?>
