...
<?php echo $this->Form->create('CompanyProfile');?>
	<fieldset>
		<legend><?php echo __('Edit Company Profile'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CompanyProfile.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CompanyProfile.id'))); ?></li>
