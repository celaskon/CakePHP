...
<?php echo $this->Form->create('CompanyProfile');?>
  ...
  <h3>Basic info:</h3>
    ...
    //echo $this->Form->input('user_id');
		echo $this->Form->input('CompanyProfile.name', array('class' => 'input-text', 'label' => 'Company Name: ', 'size' => 50));
    ...
    foreach ($languages as $language):
        ...
        echo $this->Form->textarea('CompanyProfile.info', array('class' => 'input-text', 'rows' => 12, 'cols' => 39));
        if ($i == 0) { 
